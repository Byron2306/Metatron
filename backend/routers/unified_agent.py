...
def _command_scope_for_type(command_type: str) -> Dict[str, str]:
    ...
    if ctype in {"run_command", "shell_command", "powershell_command", "kill_process", "collect_forensics", "update_config", "integration_runtime"}:
...
def _resolve_command_target(command_type: str, parameters: Dict[str, Any], agent_id: str) -> str:
    ...
    if ctype == "integration_runtime":
        return str(params.get("tool") or f"agent:{agent_id}")[:240]
