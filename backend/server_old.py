...
async def download_agent_script():
    ...
    backend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://cyber-sentinel-51.preview.emergentagent.com")
    ...
    content = content.replace(
        '"API_URL": "https://cyber-sentinel-51.preview.emergentagent.com/api"',
