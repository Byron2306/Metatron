...
async def download_agent_script():
    ...
    backend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://aidefender-22.preview.emergentagent.com")
    ...
    content = content.replace(
        '"API_URL": "https://aidefender-22.preview.emergentagent.com/api"',
