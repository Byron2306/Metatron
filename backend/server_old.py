...
async def download_agent_script():
    ...
    backend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://security-hardening-15.preview.emergentagent.com")
    content = content.replace(
        'CLOUD_API_URL = "https://security-hardening-15.preview.emergentagent.com/api"',
        f'CLOUD_API_URL = "{backend_url}/api"'
    )
    # Also update for legacy format
    content = content.replace(
        '"API_URL": "https://security-hardening-15.preview.emergentagent.com/api"',
