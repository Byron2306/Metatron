...
class AdversarialHarness:
    ...
    def _soar_event(
        ...
        This documents the automated defensive response: incident creation,
        session isolation, threat-intel enrichment, and (when the mirror world
        activates) attacker redirection to a synthetic surface.
        """
        ts = datetime.now(timezone.utc).isoformat()
        severity = "critical" if maze_activated else "high"
