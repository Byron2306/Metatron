...
try:
    from services.boot_attestation import get_boot_attestation_service
except ImportError:
    get_boot_attestation_service = None

try:
    from services.boot_measurement import BootMeasurementService
except ImportError:
    BootMeasurementService = None

try:
    from services.boot_eventlog_reader import get_boot_eventlog_reader
except ImportError:
