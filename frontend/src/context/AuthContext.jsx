...
// DEBUG: expose resolved backend info during development
if (process.env.NODE_ENV !== 'production') {
  // eslint-disable-next-line no-console
  console.log('[AuthContext] REACT_APP_BACKEND_URL=', process.env.REACT_APP_BACKEND_URL, 'resolvedBackendUrl=', resolvedBackendUrl, 'API=', API);
}
