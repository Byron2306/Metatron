...
//  Metatron Agent iOS
//
//  SwiftUI interface matching Defender installer style for iOS
//
...
// ASCII Banner View (Compact for mobile)
        ...
        NavigationView {
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Text("ID: \(agent.agentId.prefix(8))...")
                        .font(.custom("Menlo", size: 8))
...
class UnifiedAgent: ObservableObject {
    ...
    @Published var wirelessEnabled = true
    ...
    private func setupAgent() {
        ...
        // Set agent name
        agentName = "iOS-\(agentId.prefix(8))"
