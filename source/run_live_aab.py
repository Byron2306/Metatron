...
_ABLATION_PRESETS: Dict[str, Dict[str, str]] = {
    "full": {},
    # Mini-Gauntlet aliases aligned to current Seraph controls.
    ...
    # Placeholder toggles for layers tracked in evidence but not yet hard-wired.
